...
async function getGroqChatStream(userQuestion) {
  return groq.chat.completions.create({
    messages: [
      ...
      {
        role: "user",
        content: `${userQuestion} Rewrite this content above 4000 words using differnt sentences without changing the core meaning in Telugu with neat headings and sections`,
      },
    ],
